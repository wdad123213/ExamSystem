...
const QuestionItem: React.FC<{ list: testPaperListItem[]; reset: () => void }> = (props) => {
    ...
    const [data, setData] = useState<testPaperListItem[]>(props.list)
